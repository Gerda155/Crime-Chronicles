    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-light">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="createAchievementModalLabel">Izveidot jaunu sasniegumu</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>

            <form action="{{ route('moderator.achievements.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control bg-secondary text-light border-0" required></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Nosacījums (pabeigto lietu skaits)</label>
                        <input type="number" name="required_cases" class="form-control bg-secondary text-light border-0" min="1" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Ikona</label>
                        <input type="file" name="icon" class="form-control bg-secondary text-light border-0" required>
                    </div>
                </div>
